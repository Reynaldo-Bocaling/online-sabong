			...
			<!-- Topbar -->
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						...
						<?php
							echo '
							<a href="adminManageReports.php" class=""><button class="btn btn-lg btn-primary"><i class="fas fa-book"></i> Bettings Reports</button></a>
							<a href="adminManageEvents.php" class=""><button class="btn btn-sm btn-success"><i class="fas fa-book"></i> Event and Teller Reports</button></a>';
						?>
						</div>
					<div class="card-body">
						<div class="row">
