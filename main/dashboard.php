        ...
        <div class="row" style=" padding-top:5px;">
			<div class="col-md-12">
				...
				<div class="row" style="padding:50px; padding-top:5px;">
					<div class="col-md-4" >
						<p style="text-align:center; background-color:blue; color:#FFF;  font-size:70px; font-weight:bold; font-family:'Lucida sans'; -webkit-text-stroke: 2px black;  border-radius: 10px; ">WALA</p>
					</div>						
						...
						<a href= "dashboardtv.php" >
							<div  style=" text-align:center; font-weight:bolder;">
								<span style="border-radius: 10px; background-color:#000; color:#FFF; padding:20px; font-size:70px; font-family:'times new roman'">
									<span style="font-size:50px; ">FIGHT#:</span> <?php echo $currentFightNumber; ?><br/></span>
									<?php	
									if($isBetting == 1){
										echo '
										<span style="border-radius: 10px;background-color:green; color:#FFF; padding:20px; font-size:60px; font-family:\'times new roman\'">OPEN</span>';
									}else if($isBetting == 4){
										echo '
										<span style="border-radius: 10px;background-color:green; color:#FFF; padding:20px; font-size:60px; font-family:\'times new roman\'">LAST CALL</span>';
									}else{
										echo '
										<span style="border-radius: 10px;background-color:red; color:#FFF; padding:20px; font-size:60px; font-family:\'times new roman\'">CLOSE</span>';
									}	
									?>
								</span>
							</div>
					...
					<div class="col-md-4">
						<p style="border-radius: 10px; text-align:center; background-color:red; color:#FFF;  font-size:70px; font-weight:bold;font-family:'lucida sans';  -webkit-text-stroke: 2px black;  border-radius: 10px; ">MERON</p>
					</div>
				</div>
				...
				<div class="row" style="margin-top:-100px;">
					<div class="col-md-4" style="text-align:center;">
						<span style="font-weight:bolder; background-color:blue; color:#FFF; text-align:center; font-size:80px; font-family:'Lucida sans'; padding:5px; padding-left:30px; padding-right:30px; border-radius: 10px;" id = "txtWala">PAYOUT</span><br/><span style="font-weight:bolder; font-size:150px;"><?php echo number_format($payoutWala,2); ?></span>
					</div>
					<div class="col-md-4"></div>
					<div class="col-md-4" style="text-align:center;">	
						<span style="font-weight:bolder; background-color:red; color:#FFF; text-align:center; font-size:80px;  font-family:'Lucida sans'; padding:5px; padding-left:30px; padding-right:30px; border-radius: 10px;"  id = "txtMeron">PAYOUT</span><br/><span style="font-weight:bolder; font-size:150px;"><?php echo number_format($payoutMeron,2); ?></span>
					</div>
				</div>
				<?php
				}else{
				...
				<div class="row" style="margin-top:-150px;">
					<div class="col-md-4" style="text-align:center;">
						<span style="font-weight:bolder; background-color:red; color:#FFF; text-align:center; font-size:80px;  font-family:'Lucida sans'; padding:5px; padding-left:30px; padding-right:30px; border-radius: 10px;"  id = "txtMeron">PAYOUT</span><br/><span style="font-weight:bolder; font-size:120px;"><?php echo number_format($payoutMeron,2); ?></span>
					</div>
					<div class="col-md-4"></div>
					<div class="col-md-4" style="text-align:center;">	
						<span style="font-weight:bolder; background-color:blue; color:#FFF; text-align:center; font-size:80px;  font-family:'Lucida sans'; padding:5px; padding-left:30px; padding-right:30px; border-radius: 10px;"  id = "txtWala">PAYOUT</span><br/><span style="font-weight:bolder; font-size:120px;"><?php echo number_format($payoutWala,2); ?></span>
					</div>
				</div>
				<?php
				}
