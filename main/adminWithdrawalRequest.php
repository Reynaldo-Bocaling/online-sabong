		...
		<div id="content" class="flex-1 flex flex-col overflow-hiddenw gap-2 bg-[#F6F8FA]">
			...
			<main class="flex-1 overflow-x-auto overflow-y-auto p-3">
                <div class="flex items-center justify-between">
                    ...
                    <p>RegisterUser/ </p>
                    <span class="font-semibold text-blue-500">Withdrawal-Of-Points</span>
                    </div>
                    <small><?php echo $currentDate ?></small>
                </div>
                <p class="text-xl text-black font-bold mb-2">Registered User List of Request for Withdrawal of Points</p>
				...
				<!-- table -->
				<div class="bg-white px-6 py-3  w-full bg-white rounded-2xl shadow-md shadow-slate-100 mt-4">
							...
							if($qtrans->num_rows > 0){
								...
								while($rtrans = $qtrans->fetch_assoc()){
									...
									<tr  style="text-align:center;">
										...
										<td class="text-sm"><button class="btn btn-primary btnWithdrawConfirm" value = "'.$rtrans['transCode'].'" data-accountID ="'.$rtrans['accountID'].'" data-id= "'.$rtrans['id'].'">ENTER PIN</button</td>
