...
if(!$_SESSION['roleID'] == 1 || !$_SESSION['roleID'] == 4){
	...
	$qfight = $mysqli->query("SELECT a.`id`, a.`fightCode`, a.`fightNumber` as fightNum, ev.`eventDate`, a.`isBetting`, a.`isWinner`, a.`payoutMeron`, a.`payoutWala`, b.`isBetting`  as bettingStatus, d.`winner` FROM `tblfights` a 
