			  ...
			  <!-- DataTales Example -->
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Registered User List of Request for Additional Points</h6>
					</div>
					<div class="card-body">
									...
									if($qtrans->num_rows > 0){
										...
										while($rtrans = $qtrans->fetch_assoc()){
											...
											<tr  style="text-align:center;">
												<td>'.$count.'</td>
												<td><button class="btn btn-primary btnDepositConfirm" value = "'.$rtrans['transCode'].'" data-accountID ="'.$rtrans['accountID'].'"  data-id="'.$rtrans['id'].'">ENTER PIN</button</td>
