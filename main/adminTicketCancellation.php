			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form method="POST" target="_blank" action="print/printCancelTicketBetAdmin.php" id="frmCancelTicketBet">
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<input id="txtCancelTicketBetBarcode" name="txtCancelTicketBetBarcode" type="text" class="form-control" style="background-color:#1f364f; text-align:center; color:yellow; font-weight:bolder; font-size:40px;height:60px; letter-spacing:2px;" value = "" placeholder="ENTER TICKET HERE" AUTOCOMPLETE = "OFF" />
									</div>
								</div>
