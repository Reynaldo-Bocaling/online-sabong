				...
				<body onload = "window.print()" style="padding:3px;">
					<div class="ticket">
						<p style="margin-top:-10px; margin-left:10px;">									
										<br/>
										<span style="font-weight:bold; font-size:9px;">SUMMARY REPORT</span><br/>
										...
										<br/>
										<span style="font-size:10px; font-weight:bold; ">Money on hand: </span><span style="font-size:12px; font-weight:bold; ">'.number_format($ttotalMoneyonhand,2).'</span>
										<br/><br/>
