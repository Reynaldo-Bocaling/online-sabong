...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div class="container-fluid">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">
										...
										<a href="staffWithdraw.php" class=""><button class="btn btn-info btn-lg" style="font-weight:bold; font-size:25px;">MOBILE WITHDRAW</button></a>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">WITHDRAW POINTS:  SCAN TICKET </h6>
						</div>
						<div class="card-body">
							<form method="POST" target="_blank" action="print/printMobileWithdraw.php" id="frmMobileWithdraw">
								<div class="row">
									<div class="col-md-12">
										<input id="txtWithdrawBarcode" name="txtWithdrawBarcode" type="text" class="form-control" style="background-color:#1f364f; text-align:center; color:yellow; font-weight:bolder; font-size:40px;height:60px; letter-spacing:2px;" value = "" placeholder="ENTER TICKET HERE" AUTOCOMPLETE = "OFF" AUTOFOCUS />
									</div>
								</div>
								<div class="row" style="margin-top:5px;">
									<div class="col-md-12">
										<input type = "submit"  value = "CONFIRM WITHDRAW" class="btn btn-success" style=" font-size:30px; font-weight:bold; width:100%; height:100%;" />
									</div>
								</div>
							</form>
						</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#frmMobileWithdraw").submit(function(){
				$.post("print/printMobileWithdraw.php", function (res) {
					location.reload();
				});
			});		
			$('#txtWithdrawBarcode').keyup(function(){
				if(this.value.length >= 14){
					$('#frmMobileWithdraw').submit();
				}
			});		
		});
	</script>
